...
const About = () => {
  ...
  return (
    <section className='px-0 md:px-[60px] lg:px-[100px]'>
      <div className='pt-[80px] grid grid-cols-1 md:grid-cols-3  '>
        <div className='flex flex-col justify-center col-span-2 px-5 rounded-2xl animate-in fade-in zoom-in duration-300 '>
        ...
        <div className=' md:pt-0 pt-5 px-5'>
