...
const Header = () => {
  return (
    <section className="px-0 md:px-[60px] lg:px-[100px] pt-[105px] bg-cyan-50">
      <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 h-full">
        {/* left side of header */}
        <div className="lg:col-span-3 md:col-span-1 p-4 flex flex-col  justify-center animate-in fade-in zoom-in duration-300">
