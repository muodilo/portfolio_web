...
const Services = () => {
  return (
    <section className="px-0 md:px-[60px] lg:px-[100px]  bg-cyan-100/50 pt-[30px] pb-[40px]">
      <div className="p-3">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 px-3 gap-4">
          <div className="animate-in fade-in zoom-in duration-300 shadow-xl service__card ">
            <div className="bg-cyan-400 shadow-lg">
              <h1 className="text-center text-[25px]">Full Stack Development</h1>
            </div>
            <div>
          ...
          <div className="animate-in fade-in zoom-in duration-300 shadow-xl service__card ">
            <div className="bg-cyan-400 shadow-lg">
              <h1 className="text-center text-[25px]">Responsive Web Design</h1>
            </div>
            <div>
          ...
          <div className="animate-in fade-in zoom-in duration-300 shadow-xl service__card ">
            <div className="bg-cyan-400 shadow-lg">
              <h1 className="text-center text-[25px]">Database Management</h1>
            </div>
            <div>
          ...
          <div className="animate-in fade-in zoom-in duration-300 shadow-xl service__card ">
            <div className="bg-cyan-400 shadow-lg">
              <h1 className="text-center text-[25px]">API Development</h1>
            </div>
            <div>
